layui.define('layer', function (exports) {
    ...
    Dialog.prototype.open = function (title, content) {
        ...
        //     success : function(layero, index){
        //         setTimeout(function(){
        //             layer.tips('点击此处返回用户组列表', '.layui-layer-setwin .layui-layer-close', {
        //                 tips: 3
        //             });
        //         },500)
        //     }
    ...
    Dialog.prototype.prompt = function (tilte, val, callable) {
    ...
    Dialog.prototype.pwd = function (tilte, val, callable) {
    ...
    Dialog.prototype.text = function (tilte, val,callable) {
